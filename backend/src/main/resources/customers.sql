#Customer and roles
INSERT INTO `focab`.`customer` (`username`, `enabled`,`fullname`,`password`,`level`) VALUES ('envolkan@gmail.com', b'1','Engin Volkan','$2a$10$Sc0P7.njy1Pqn/U5dd9TWuE2.U0aHivhQkvpKWsD1mNaFmFoCzxau','1000');
